...
* update tab title to keep font colors [StefKors]
* generate screenshots [StefKors]
* Add support for scroll snapping [StefKors]
* Add support for scrollable tabs [Graham McCulloch]
